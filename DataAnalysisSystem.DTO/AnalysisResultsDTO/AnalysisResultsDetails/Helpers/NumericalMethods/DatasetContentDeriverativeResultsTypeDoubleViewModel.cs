...
{
    public class DatasetContentDeriverativeResultsTypeDoubleViewModel
    {
        public DatasetContentDeriverativeResultsTypeDoubleViewModel()
        {

        }

        public DatasetContentDeriverativeResultsTypeDoubleViewModel(string attributeName, int positionInDataset, bool columnSelected)
        {
