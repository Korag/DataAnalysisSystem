...
namespace DataAnalysisSystem.Controllers
{
    public class UserSystemInteractionController : Controller
    {
        ...
        private const string CONTACT_ACTION_CONTROLLER = "UserSystemInteraction";

        private const string USERLOGIN_ACTION_NAME = "UserLogin";
        private const string USERLOGIN_ACTION_CONTROLLER = "User";
        ...
        public IActionResult ContactWithAdministration(ContactWithAdministrationViewModel contactViewModel)
        {
            ...
            if (this.User.Identity.IsAuthenticated)
            {
                ...
                controller = CONTACT_ACTION_CONTROLLER;
            }
            else
            {
                actionName = USERLOGIN_ACTION_NAME;
                controller = USERLOGIN_ACTION_CONTROLLER;
            }

            return RedirectToAction(actionName, controller, new { notificationMessage = notificationMessage });
        }
    }
}
